...
namespace kinoli\hackjob;

use kinoli\hackjob\twigextensions\HackJobTwigExtension;
...
class HackJob extends Plugin
{
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new HackJobTwigExtension());
